...
#include "FSPair.H"
#include "superpositionNucleateBoilingFSHeatTransferCoefficient.H"
...
{
    defineTypeNameAndDebug(superpositionNucleateBoiling, 0);
...
Foam::scalar 
Foam::FSHeatTransferCoefficientModels::superpositionNucleateBoiling::value
(
    const label& celli
) const
{
