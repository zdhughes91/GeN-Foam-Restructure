...
#include "FSPair.H"
#include "NusseltAndWallFSHeatTransferCoefficient.H"
...
{
    defineTypeNameAndDebug(NusseltAndWall, 0);
...
Foam::FSHeatTransferCoefficientModels::NusseltAndWall::NusseltAndWall
(
    const FSPair& pair,
...
Foam::scalar Foam::FSHeatTransferCoefficientModels::NusseltAndWall::value
(
    const label& celli
) const
{
