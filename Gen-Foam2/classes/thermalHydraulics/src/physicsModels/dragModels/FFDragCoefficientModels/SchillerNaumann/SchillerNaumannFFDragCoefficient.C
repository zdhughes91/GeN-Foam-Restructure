...
#include "FFPair.H"
#include "SchillerNaumannFFDragCoefficient.H"
...
Foam::FFDragCoefficientModels::SchillerNaumann::SchillerNaumann
(
    const FFPair& pair,
...
Foam::scalar Foam::FFDragCoefficientModels::SchillerNaumann::value
(
    const label& celli
) const
{
